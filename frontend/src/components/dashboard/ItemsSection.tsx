				...
				<div className="text-center py-12">
					...
					<button
						onClick={() => {
							...
							document.querySelector<HTMLButtonElement>('[data-tab="upload"]')?.click();
						}}
						...
						>
							...
							<div className="aspect-square relative bg-gray-100">
								...
								{item.pendingRequests > 0 && (
									<div className="absolute top-4 left-4 bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-xs font-medium border border-orange-200">
										{item.pendingRequests} requests
									</div>
								)}
							</div>
							...
							<div className="p-4">
								...
								<p className="text-sm text-gray-600 mb-3">Listed {formatDate(item.createdAt)}</p>
